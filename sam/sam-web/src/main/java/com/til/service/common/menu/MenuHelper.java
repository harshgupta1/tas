...
public class MenuHelper {
    ...
    static {
        try {
            ...
            ParsedMenu editorMenu = unmarshall(MenuHelper.class.getResourceAsStream("/com/til/service/common/menu/editor/editor-menu.xml"));
            menus.put("editor", editorMenu);
            
            ParsedMenu adminMenu = unmarshall(MenuHelper.class.getResourceAsStream("/com/til/service/common/menu/admin/admin-menu.xml"));
    ...
    private static Menu buildMenu(ParsedMenu menuConfig, String currentAction, 
        ...
        while(tabsIter.hasNext()) {
            ...
            /*if(configTab.getEnabledProperty() != null) {
                includeTab = getBooleanProperty(website.getKey(),website.getCode(),configTab.getEnabledProperty());
            } else if(configTab.getDisabledProperty() != null) {
                includeTab = ! getBooleanProperty(website.getKey(),website.getCode(),configTab.getDisabledProperty());
            }*/
            ...
            if(includeTab) {
                ...
                includeTab = isPermitted(configTab.getPerm(), user, website);
            }
            ...
            if(includeTab) {
                ...
                while(itemsIter.hasNext()) {
                    ...
                    /*if(configTabItem.getEnabledProperty() != null) {
                        includeItem = getBooleanProperty(website.getKey(),website.getCode(),configTabItem.getEnabledProperty());
                    } else if(configTabItem.getDisabledProperty() != null) {
                        includeItem = !getBooleanProperty(website.getKey(),website.getCode(),configTabItem.getDisabledProperty());
                    }*/
...
//                        	 Commented by Harsh
                    ...
                    if(includeItem) {
                        // weblog permissions check
                        includeItem = isPermitted(configTabItem.getPerm(), user, website);
                    }
    ...
    private static boolean isPermitted(String perm, User user, Website website) {
